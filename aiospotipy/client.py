...
class AioSpotify:
    ...
    def __init__(self, auth=None, http_session=None, client_credentials_manager=None, timeout=None,
                 proxy=None):
        """
        ...
        :param http_session:
            A aiohttp session object or a truthy value to create one.
        ...
        if isinstance(http_session, aiohttp.ClientSession):
    ...
    async def _internal_call(self, method, url, payload, params):
        ...
        r = await self._session.request(method, url, headers=headers, proxy=self.proxy, **args)
        ...
        try:
            ...
            r_text = await r.text()
            if await r_text and len(r_text) > 0 and r_text != 'null':
                raise SpotifyException(r.status,
                                       -1, '%s:\n %s' % (r.url, await r.json()['error']['message']),
                                       headers=r.headers)
            else:
                raise SpotifyException(r.status,
    ...
    async def next(self, result):
        ...
        """
        if result['next']:
            return await self._get(result['next'])
    ...
    async def track(self, track_id):
        ...
        return await self._get('tracks/' + trid)
    ...
    async def tracks(self, tracks, market=None):
        ...
        tlist = self.loop.run_until_complete(asyncio.gather(*tlist))
        return await self._get('tracks/?ids=' + ','.join(tlist), market=market)
    ...
    async def artist(self, artist_id):
        ...
        trid = await self._get_id('artist', artist_id)
        return await self._get('artists/' + trid)
    ...
    async def artists(self, artists):
        ...
        tlist = self.loop.run_until_complete(asyncio.gather(*tlist))
        return await self._get('artists/?ids=' + ','.join(tlist))
    ...
    async def artist_albums(self, artist_id, album_type=None, country=None, limit=20,
        ...
        trid = await self._get_id('artist', artist_id)
        return await self._get('artists/' + trid + '/albums', album_type=album_type,
    ...
    async def artist_top_tracks(self, artist_id, country='US'):
        ...
        trid = await self._get_id('artist', artist_id)
        return await self._get('artists/' + trid + '/top-tracks', country=country)
    ...
    async def artist_related_artists(self, artist_id):
        ...
        """
        trid = await self._get_id('artist', artist_id)
        return await self._get('artists/' + trid + '/related-artists')
    ...
    async def album(self, album_id):
        ...
        return await self._get('albums/' + trid)
    ...
    async def album_tracks(self, album_id, limit=50, offset=0):
        ...
        trid = await self._get_id('album', album_id)
        return await self._get('albums/' + trid + '/tracks/', limit=limit,
                               offset=offset)
    ...
    async def albums(self, albums):
        ...
        tlist = self.loop.run_until_complete(asyncio.gather(*tlist))
        return await self._get('albums/?ids=' + ','.join(tlist))
    ...
    async def search(self, q, limit=10, offset=0, type='track', market=None):
        ...
        """
        return await self._get('search', q=q, limit=limit, offset=offset, type=type, market=market)
    ...
    async def user(self, user):
        ...
        """
        return await self._get('users/' + user)
    ...
    async def current_user_playlists(self, limit=50, offset=0):
        """ Get current user playlists without required getting his profile
            Parameters:
                ...
                - offset - the index of the first item to return
        """
        return await self._get("me/playlists", limit=limit, offset=offset)
    ...
    async def user_playlists(self, user, limit=50, offset=0):
        """ Gets playlists of a user
            ...
            Parameters:
                ...
                - offset - the index of the first item to return
        """
        return await self._get("users/%s/playlists" % user, limit=limit,
                               offset=offset)
    ...
    async def user_playlist_tracks(self, user, playlist_id=None, fields=None,
        ...
        """
        plid = await self._get_id('playlist', playlist_id)
        return await self._get("users/%s/playlists/%s/tracks" % (user, plid),
    ...
    async def user_playlist_create(self, user, name, public=True, description=''):
        ...
        return await self._post("users/%s/playlists" % (user,), payload=data)
    ...
    async def user_playlist_change_details(
        ...
        data['name'] = name
        return await self._put("users/%s/playlists/%s" % (user, playlist_id),
                               payload=data)
    ...
    async def user_playlist_add_tracks(self, user, playlist_id, tracks,
                                       position=None):
        ...
        ftracks = self.loop.run_until_complete(asyncio.gather(*ftracks))
        return await self._post("users/%s/playlists/%s/tracks" % (user, plid),
    ...
    async def user_playlist_replace_tracks(self, user, playlist_id, tracks):
        ...
        return await self._put("users/%s/playlists/%s/tracks" % (user, plid),
                               payload=payload)
    ...
    async def user_playlist_remove_all_occurrences_of_tracks(
        ...
        if snapshot_id:
            payload["snapshot_id"] = snapshot_id
        return await self._delete("users/%s/playlists/%s/tracks" % (user, plid),
                                  payload=payload)
    ...
    async def user_playlist_follow_playlist(self, playlist_owner_id, playlist_id):
        ...
        """
        return await self._put("users/{}/playlists/{}/followers".format(playlist_owner_id, playlist_id))
    ...
    async def user_playlist_is_following(self, playlist_owner_id, playlist_id, user_ids):
        ...
        """
        return await self._get("users/{}/playlists/{}/followers/contains?ids={}".format(playlist_owner_id, playlist_id,
                                                                                        ','.join(user_ids)))
    ...
    async def current_user_playing_track(self):
    ...
    async def current_user_saved_albums(self, limit=20, offset=0):
        ...
        """
        return await self._get('me/albums', limit=limit, offset=offset)
    ...
    async def current_user_followed_artists(self, limit=20, after=None):
        ...
        """
        return await self._get('me/following', type='artist', limit=limit,
                               after=after)
    ...
    async def current_user_saved_tracks_delete(self, tracks=None):
        ...
        if tracks is not None:
            tlist = [self._get_id('track', t) for t in tracks]
            tlist = self.loop.run_until_complete(asyncio.gather(*tlist))
        return await self._delete('me/tracks/?ids=' + ','.join(tlist))
    ...
    async def current_user_saved_tracks_contains(self, tracks=None):
        ...
        if tracks is not None:
            tlist = [self._get_id('track', t) for t in tracks]
            tlist = self.loop.run_until_complete(asyncio.gather(*tlist))
        return await self._get('me/tracks/contains?ids=' + ','.join(tlist))
    ...
    async def current_user_saved_tracks_add(self, tracks=None):
        ...
        if tracks is not None:
            tlist = [self._get_id('track', t) for t in tracks]
        return await self._put('me/tracks/?ids=' + ','.join(tlist))

    async def current_user_top_artists(self, limit=20, offset=0,
    ...
    async def current_user_top_tracks(self, limit=20, offset=0,
                                      time_range='medium_term'):
    ...
    async def current_user_saved_albums_add(self, albums=[]):
        ...
        alist = self.loop.run_until_complete(asyncio.gather(*alist))
        return await self._put('me/albums?ids=' + ','.join(alist))

    async def user_follow_artists(self, ids=[]):
        ''' Follow one or more artists
            Parameters:
                - ids - a list of artist IDs
        '''
        return await self._put('me/following?type=artist&ids=' + ','.join(ids))

    async def user_follow_users(self, ids=[]):
        ''' Follow one or more users
            Parameters:
                - ids - a list of user IDs
        '''
        return await self._put('me/following?type=user&ids=' + ','.join(ids))
        ...
        """ Get a list of Spotify featured playlists
            ...
            Parameters:
                ...
                - offset - The index of the first item to return. Default: 0
                  ...
                  items.
        """
        return await self._get('browse/featured-playlists', locale=locale,
        ...
        """ Get a list of new album releases featured in Spotify
            ...
            Parameters:
                ...
                - offset - The index of the first item to return. Default: 0
                  ...
                  items.
        """
        return await self._get('browse/new-releases', country=country, limit=limit,
                               offset=offset)
        ...
        """ Get a list of new album releases featured in Spotify
            ...
            Parameters:
                ...
                - offset - The index of the first item to return. Default: 0
                  ...
                  items.
        """
        return await self._get('browse/categories', country=country, locale=locale,
                               limit=limit, offset=offset)

    async def category_playlists(self, category_id=None, country=None, limit=20,
                                 offset=0):
        """ Get a list of new album releases featured in Spotify
            ...
            Parameters:
                ...
                - offset - The index of the first item to return. Default: 0
                  ...
                  items.
        """
        return await self._get('browse/categories/' + category_id + '/playlists',
                               country=country, limit=limit, offset=offset)

    async def recommendations(self, seed_artists=None, seed_genres=None,
        ...
        if seed_artists:
            seed_artists = [self._get_id('artist', a) for a in seed_artists]
            seed_artists = self.loop.run_until_complete(asyncio.gather(*seed_artists))
            params['seed_artists'] = ','.join(seed_artists)

        if seed_genres:
            params['seed_genres'] = ','.join(seed_genres)
        if seed_tracks:
            seed_tracks = [self._get_id('track', t) for t in seed_tracks]
            seed_tracks = self.loop.run_until_complete(asyncio.gather(*seed_tracks))
    ...
    async def recommendation_genre_seeds(self):
        ...
        """
        return await self._get('recommendations/available-genre-seeds')
    ...
    async def audio_features(self, tracks=[]):
        ...
        if isinstance(tracks, str):
            trackid = await self._get_id('track', tracks)
            results = await self._get('audio-features/?ids=' + trackid)
        else:
            tlist = [self._get_id('track', t) for t in tracks]
            tlist = self.loop.run_until_complete(asyncio.gather(*tlist))
            results = await self._get('audio-features/?ids=' + ','.join(tlist))
    ...
    async def audio_analysis(self, id):
        """ Get audio analysis for a track based upon its Spotify ID
            Parameters:
                - id - a track URIs, URLs or IDs
        """
        id = await self._get_id('track', id)
        return await self._get('audio-analysis/' + id)

    async def devices(self):
        ''' Get a list of user's available devices.
        '''
        return await self._get("me/player/devices")
    ...
    async def current_playback(self, market=None):
        ''' Get information about user's current playback.
            ...
            Parameters:
                - market - an ISO 3166-1 alpha-2 country code.
        '''
        return await self._get("me/player", market=market)
    ...
    async def currently_playing(self, market=None):
        ''' Get user's currently playing track.
            ...
            Parameters:
                - market - an ISO 3166-1 alpha-2 country code.
        '''
        return await self._get("me/player/currently-playing", market=market)

    async def transfer_playback(self, device_id, force_play=True):
        ...
        return await self._put("me/player", payload=data)
    ...
    async def start_playback(self, device_id=None, context_uri=None, uris=None, offset=None):
        ...
        if offset is not None:
            data['offset'] = offset
        return await self._put(self._append_device_id("me/player/play", device_id), payload=data)
    ...
    async def pause_playback(self, device_id=None):
        ''' Pause user's playback.
            ...
            Parameters:
                - device_id - device target for playback
        '''
        return await self._put(self._append_device_id("me/player/pause", device_id))
    ...
    async def next_track(self, device_id=None):
        ''' Skip user's playback to next track.
            ...
            Parameters:
                - device_id - device target for playback
        '''
        return await self._post(self._append_device_id("me/player/next", device_id))
    ...
    async def previous_track(self, device_id=None):
        ''' Skip user's playback to previous track.
            ...
            Parameters:
                - device_id - device target for playback
        '''
        return await self._post(self._append_device_id("me/player/previous", device_id))

    async def seek_track(self, position_ms, device_id=None):
        ...
        if not isinstance(position_ms, int):
            ...
            return
        return await self._put(self._append_device_id("me/player/seek?position_ms=%s" % position_ms, device_id))

    async def repeat(self, state, device_id=None):
        ...
        if state not in ['track', 'context', 'off']:
            ...
            return
        await self._put(self._append_device_id("me/player/repeat?state=%s" % state, device_id))

    async def volume(self, volume_percent, device_id=None):
        ''' Set playback volume.
        ...
        if volume_percent < 0 or volume_percent > 100:
            ...
            return
        await self._put(self._append_device_id("me/player/volume?volume_percent=%s" % volume_percent, device_id))

    async def shuffle(self, state, device_id=None):
        ...
        await self._put(self._append_device_id("me/player/shuffle?state=%s" % state, device_id))
